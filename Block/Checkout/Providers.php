...
class Providers extends \Magento\Payment\Block\Form
{
	...
	{
		$compropagoData['providers']=$this->method->getProviders(); 
		$compropagoData['showlogo']='yes';                              
		$compropagoData['description']='Con Compropago puedes etc'; 
		$compropagoData['instrucciones']='Selecciona una tienda';
		
		Views::loadView('providers',$compropagoData);
