...
namespace ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\Json;


use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V10\CpOrderInfo10;
use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V10\NewOrderInfo10;
use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V10\SmsInfo10;
use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V11\CpOrderInfo11;
use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V11\NewOrderInfo11;
use ComproPago\MgPayment\Model\Api\CompropagoSdk\Factory\V11\SmsInfo11;
...
class Serialize
{
    ...
    public static function newOrderInfo11($source)
    {
        ...
        $res->instructions->details->amount = $obj->instructions->details->payment_amount;
        $res->instructions->details->store = $obj->instructions->details->payment_store;
